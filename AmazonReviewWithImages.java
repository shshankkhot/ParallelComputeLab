 ...
 */
public class AmazonReviewWithImages extends Configured implements Tool {
	// Just used for logging
	protected static final Logger LOG = LoggerFactory.getLogger(AmazonReviewWithImages.class);

	// This is the execution entry point for Java programs
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(HBaseConfiguration.create(), new AmazonReviewWithImages(), args);
		System.exit(res);
	}
	...
	public int run(String[] args) throws Exception {
		...
		Job job = Job.getInstance(getConf(), "AmazonReviewWithImages");
		job.setJarByClass(AmazonReviewWithImages.class);
	...
	public static class MapReduceMapper extends TableMapper<Text, IntWritable> {
		...
		protected void setup(Context context) {
			...
			rowsProcessed = context.getCounter("AmazonReviewWithImages", "Rows Processed");
    		}
